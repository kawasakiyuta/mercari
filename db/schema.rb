...
ActiveRecord::Schema.define(version: 2019_09_23_124003) do
  ...
  create_table "user_googles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_user_googles_on_email", unique: true
    t.index ["reset_password_token"], name: "index_user_googles_on_reset_password_token", unique: true
  end
